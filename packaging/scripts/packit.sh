...
DESKTOP_FILE="$REPO_ROOT/com.github.Switchcraft.desktop"
...
install -Dm644 "$DESTDIR/usr/share/applications/com.github.Switchcraft.desktop" "$APPDIR/com.github.Switchcraft.desktop"
install -Dm644 "$DESTDIR/usr/share/icons/hicolor/512x512/apps/com.github.Switchcraft.png" "$APPDIR/com.github.Switchcraft.png"

desktop-file-validate "$APPDIR/com.github.Switchcraft.desktop"
